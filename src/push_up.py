...
# Definir caminho:
VIDEO_PATH = r"C:\Uni\1_ano\1_semestre\VC\VC_proj\src\pushup1.mp4"
...
# Análise de forma 
HIP_SAG_ANGLE_WARN = 165     
HIP_SAG_ANGLE_BAD = 150       
DEPTH_TOLERANCE = 6           
LOCKOUT_TOLERANCE = 25        
good_reps = 0
incomplete_reps = 0
rep_min_angle = None
rep_max_angle = None
...
# Cálculo do ângulo entre três pontos
